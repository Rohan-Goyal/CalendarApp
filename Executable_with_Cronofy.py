...
cronofy_signup="https://app.cronofy.com/sign_up"
# Url to sign up for a developer account and get an auth token/ calendar ID

crono_cal = Client(access_token="Get your own from cronofy")
cal_id = "Fill it based on your most commonly used calendar"
